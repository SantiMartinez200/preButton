          ...
          <div class="card-body">
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <td>
                  <a href="{{route("edit", $eachParam->id)}}" class="btn btn-primary btn-sm m-1"><i class="bi bi-pencil-square"></i>Editar</a>
...
<div class="row justify-content-center mt-3">
  <div class="col-md-12">
    <div class="container">
      <div class="card">
        <div class="card-header">Listado de Años</div>
        <div class="card-body">
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
        ...
        <td colspan="6">
        <span class="text-danger">
          <strong>No hay Años registrados!</strong>
        </span>
        </td>
      @endforelse
            </tbody>
